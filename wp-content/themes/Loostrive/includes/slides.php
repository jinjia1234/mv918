		...
		<ul>
			...
			<li>
                <a href="<?php the_permalink();?>" target="_blank" rel="nofollow" title="<?php the_title_attribute();?>">
                    <?php
					//echo post_thumbnail_img(650,370)
					echo post_thumbnail_img(350,370)
					?>
                </a>
            	<div class="flex-caption">  
                    ...
                    <p class="slides_entry">
						<?php if (has_excerpt()) {
							echo mb_strimwidth(strip_tags(apply_filters('the_excerpt',get_the_excerpt())), 0, 350,"...","utf-8");
						}else {
							echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 350,"...","utf-8");
						} ?>
                     </p>
